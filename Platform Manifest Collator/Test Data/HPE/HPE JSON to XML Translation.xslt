  ...
  <xsl:template name="SourceXMLtoRecord">
    ...
    <Device>
      ...
      <Components>
        ...
        <!-- CPU -->
        <xsl:if test="COMPONENTCLASS/COMPONENTCLASSVALUE='00010002'">         
          <Component>            
            <Class>CPU</Class>
            <Manufacturer>
              <xsl:value-of select="MANUFACTURER"/>
        ...
        <!-- Memory -->
        <xsl:if test="COMPONENTCLASS/COMPONENTCLASSVALUE='00060016'">         
          <Component>            
            <Class>Memory</Class>
            <Manufacturer>
              <xsl:value-of select="MANUFACTURER"/>
        ...
        <!-- TPM -->
        <xsl:if test="COMPONENTCLASS/COMPONENTCLASSVALUE='00040009'">         
          <Component>            
            <Class>TPM</Class>
            <Manufacturer>
              <xsl:value-of select="MANUFACTURER"/>
